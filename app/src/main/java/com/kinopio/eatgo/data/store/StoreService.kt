...
interface StoreService {
    ...
    fun changeStoreStatusOpen(@Path("storeId") storeId: Int,
                              @Body storeHistoryRequestDto: StoreHistoryRequestDto ) : Call<StoreHistoryRequestDto>

    // return 값 변경해줘야 함
     @POST("api/v1/stores/{storeId}/open")
    fun changeStoreStatusClose(@Path("storeId") storeId: Int) : Call<StoreHistoryRequestDto>
}